...
namespace RajatPatwari.Vertex.Runtime
{
    public static class StandardLibrary
    {
        ...
        static StandardLibrary()
        {
            ...
            packages.Add(Package.MakeRuntimePackage("env",
                new (string, Delegate)[]
                {
            ...
            packages.Add(Package.MakeRuntimePackage("opr",
                new (string, Delegate)[]
                {
            ...
            packages.Add(Package.MakeRuntimePackage("cmp",
                new (string, Delegate)[]
                {
            ...
            packages.Add(Package.MakeRuntimePackage("sfn",
                new (string, Delegate)[]
                {
                    ...
                    ("sub",
                        (Func<string, long, long, string>)((value, index, length) =>
            ...
            packages.Add(Package.MakeRuntimePackage("err",
                new (string, Delegate)[]
                {
            ...
            packages.Add(Package.MakeRuntimePackage("io",
                new (string, Delegate)[]
                {
            ...
            packages.Add(Package.MakeRuntimePackage("file",
                new (string, Delegate)[]
                {
